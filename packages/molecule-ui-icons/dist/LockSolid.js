...
const LockSolid = ({ fill, size = 'normal', customSize, className }) => {
    ...
    return (React.createElement("svg", { className: classes, style: { width: customSize, height: customSize }, xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' },
        React.createElement("path", { fill: fill, fillRule: "evenodd", d: "M10 10V8a2 2 0 114 0v2h2a1 1 0 011 1v6a1 1 0 01-1 1H8a1 1 0 01-1-1v-6a1 1 0 011-1h2zm3-2v2h-2V8a1 1 0 112 0zm0 6a1 1 0 01-.5.866v.634a.5.5 0 01-1 0v-.634A1 1 0 1113 14z", clipRule: "evenodd" })));
};
