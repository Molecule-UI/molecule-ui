...
const SendSolid = ({ fill, size = 'normal', customSize, className }) => {
    ...
    return (React.createElement("svg", { className: classes, style: { width: customSize, height: customSize }, xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' },
        React.createElement("path", { fill: fill, fillRule: "evenodd", d: "M5 14.91L10.454 12 5 9.09V4l15 8-15 8v-5.09z", clipRule: "evenodd" })));
};
exports.default = SendSolid;
