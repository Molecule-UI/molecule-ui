...
const StairsMenu = ({ fill, size = 'normal', customSize, className }) => {
    ...
    return (React.createElement("svg", { className: classes, style: { width: customSize, height: customSize }, xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' },
        React.createElement("path", { fill: fill, fillRule: "evenodd", d: "M10 9a1 1 0 011-1h8a1 1 0 110 2h-8a1 1 0 01-1-1zm-3 3a1 1 0 011-1h8a1 1 0 110 2H8a1 1 0 01-1-1zm-2 2a1 1 0 100 2h8a1 1 0 100-2H5z", clipRule: "evenodd" })));
};
exports.default = StairsMenu;
