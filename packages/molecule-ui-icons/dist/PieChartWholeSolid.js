...
const PieChartWholeSolid = ({ fill, size = 'normal', customSize, className }) => {
    ...
    return (React.createElement("svg", { className: classes, style: { width: customSize, height: customSize }, xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' },
        React.createElement("path", { fill: fill, fillRule: "evenodd", d: "M18.988 15.898A8 8 0 0012.5 4.016v7.711l6.488 4.17zm-.542.84A8 8 0 1111.5 4.015v8.258l.23.148 6.716 4.317z", clipRule: "evenodd" })));
};
exports.default = PieChartWholeSolid;
